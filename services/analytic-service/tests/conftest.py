...
The /analytic/predict endpoint is backed by an XGBoost model trained on
startup from the real ventilation_history.csv. Tests point the service
at the repo's db/ files (relative to this test directory) so the model
is trained once per session against ground-truth data.
"""
